...
\begin{itemize}
    ...
    \item \textbf{Telefonos}
        \begin{itemize}
            \item \textbf{TelefonoID} (PK)
            \item ProveedorID (FK)
            \item NumeroTelefono (VARCHAR(50))
        \end{itemize}
...
\begin{figure}[H]
    \begin{center}
        ...
        \caption{Relational Model of our case study}
    \end{center}
\end{figure}


\section{Development of the Physical Model}

Based on our relational model, we used the PGModeler tool to obtain our SQL code that we will use to continue with the development of our project.
